          ...
          <tbody className="bg-white">
            {CONNECTIVITY_FEATURES.map((feature) => (
              <tr key={feature.id} className="hover:bg-gray-50">
                ...
                {/* Q11a: Available (Yes=1, No=2) - REQUIRED */}
                <td className="border border-gray-400 px-2 py-2 text-center">
                  <div className="flex justify-center gap-4">
                    <label className="flex items-center gap-1">
                      <input
                        type="radio"
                        value="1"
                        {...register(`Q11a_Available_${feature.id}`, { required: true })}
                        className="w-4 h-4"
                      />
                      <span>Yes</span>
                    </label>
                  ...
                  {errors[`Q11a_Available_${feature.id}`] && <span className="text-red-500 text-[10px]">Required</span>}
                </td>
                ...
                {/* Q11c: Importance (1/2/3) - REQUIRED */}
                <td className="border border-gray-400 px-2 py-2 text-center">
                  <div className="flex justify-center gap-2">
                    <label className="flex items-center gap-1">
                      <input
                        type="radio"
                        value="1"
                        {...register(`Q11c_Importance_${feature.id}`, { required: true })}
                        className="w-4 h-4"
                      />
                      <span>1</span>
                    </label>
                  ...
                  {errors[`Q11c_Importance_${feature.id}`] && <span className="text-red-500 text-[10px]">Required</span>}
                </td>
                
                {/* Q11d: Aftermarket (Yes=1, No=2) - REQUIRED */}
                <td className="border border-gray-400 px-2 py-2 text-center">
                  <div className="flex justify-center gap-4">
                    <label className="flex items-center gap-1">
                      <input
                        type="radio"
                        value="1"
                        {...register(`Q11d_Aftermarket_${feature.id}`, { required: true })}
                        className="w-4 h-4"
                      />
                      <span>Yes</span>
                    </label>
                  ...
                  {errors[`Q11d_Aftermarket_${feature.id}`] && <span className="text-red-500 text-[10px]">Required</span>}
                </td>
