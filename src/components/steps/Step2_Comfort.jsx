          ...
          <tbody>
            {COMFORT_FEATURES.map((feature, index) => (
              <tr key={feature.id} className="hover:bg-gray-50">
                ...
                {/* Q6a - Available (Yes/No Radio) - REQUIRED */}
                <td className="border border-gray-400 px-2 py-2 text-center">
                  <div className="flex justify-center gap-3">
                    <label className="flex items-center gap-1 cursor-pointer">
                      <input
                        type="radio"
                        value="1"
                        {...register(`Q6a_Available_${feature.id}`, { required: true })}
                  ...
                  {errors[`Q6a_Available_${feature.id}`] && <span className="text-red-500 text-[10px]">Required</span>}
                </td>
                ...
                {/* Q6c - Importance (1, 2, or 3) - REQUIRED */}
                <td className="border border-gray-400 px-2 py-2 text-center">
                  <div className="flex justify-center gap-2">
                    <label className="flex items-center gap-1 cursor-pointer">
                      <input
                        type="radio"
                        value="1"
                        {...register(`Q6c_Importance_${feature.id}`, { required: true })}
                        className="w-3 h-3 text-blue-600"
                      />
                  ...
                  {errors[`Q6c_Importance_${feature.id}`] && <span className="text-red-500 text-[10px]">Required</span>}
                </td>
                
                {/* Q6d - Aftermarket Available (Yes/No Radio) - REQUIRED */}
                <td className="border border-gray-400 px-2 py-2 text-center">
                  <div className="flex justify-center gap-3">
                    <label className="flex items-center gap-1 cursor-pointer">
                      <input
                        type="radio"
                        value="1"
                        {...register(`Q6d_Aftermarket_${feature.id}`, { required: true })}
                        className="w-3 h-3 text-blue-600"
                      />
                      <span className="text-xs">Yes</span>
                    </label>
                  ...
                  {errors[`Q6d_Aftermarket_${feature.id}`] && <span className="text-red-500 text-[10px]">Required</span>}
                </td>
