                  ...
                  <div className="flex justify-center gap-4">
                    <label className="flex items-center gap-1">
                      <input
                        type="radio"
                        value="1"
                        {...register(`Q10a_Available_${feature.id}`)}
                        className="w-4 h-4"
                      />
                      <span>Yes</span>
                    </label>
                  ...
                  <div className="flex justify-center gap-2">
                    <label className="flex items-center gap-1">
                      <input
                        type="radio"
                        value="1"
                        {...register(`Q10c_Importance_${feature.id}`)}
                        className="w-4 h-4"
                      />
                      <span>1</span>
                    </label>
                  ...
                  <div className="flex justify-center gap-4">
                    <label className="flex items-center gap-1">
                      <input
                        type="radio"
                        value="1"
                        {...register(`Q10d_Aftermarket_${feature.id}`)}
                        className="w-4 h-4"
                      />
                      <span>Yes</span>
                    </label>
