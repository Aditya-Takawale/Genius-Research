            ...
            <tbody>
              <tr className="hover:bg-gray-50">
                ...
                <td className="border border-gray-400 px-4 py-2 text-center">
                  <input type="radio" value="1" {...register('Q7c_Category')} className="w-4 h-4 text-blue-600 focus:ring-2 focus:ring-blue-500" />
                </td>
              </tr>
              <tr className="hover:bg-gray-50">
                ...
                <td className="border border-gray-400 px-4 py-2 text-center">
                  <input type="radio" value="2" {...register('Q7c_Category')} className="w-4 h-4 text-blue-600 focus:ring-2 focus:ring-blue-500" />
                </td>
              </tr>
              <tr className="hover:bg-gray-50">
                ...
                <td className="border border-gray-400 px-4 py-2 text-center">
                  <input type="radio" value="3" {...register('Q7c_Category')} className="w-4 h-4 text-blue-600 focus:ring-2 focus:ring-blue-500" />
                </td>
              </tr>
            </tbody>
          </table>
